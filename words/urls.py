...
urlpatterns = [
    ...
    path('api/cet6/translate-analyze/', views.api_cet6_translate_analyze, name='api_cet6_translate_analyze'),
    path('api/cet6/grade-translation/', views.api_cet6_grade_translation, name='api_cet6_grade_translation'),
